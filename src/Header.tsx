    ...
    <div className="flex gap-4 p-5 bg-white border-2 border-blue-200 rounded-2xl shadow-sm mt-6 mx-4 md:mx-6 lg:mx-8">
      <button
        ...
        className={`flex-1 font-bold py-2 px-4 rounded-full transition-colors 
          hover:bg-gradient-to-r hover:from-[#ed7b84] hover:to-[#9055ff] hover:text-white ${
      ...
      <button
        ...
        className={`flex-1 font-bold py-2 px-4 rounded-full transition-colors 
          hover:bg-gradient-to-r hover:from-[#d6ff7f] hover:to-[#00b3cc] hover:text-white ${
      ...
      <button
        ...
        className={`flex-1 font-bold py-2 px-4 rounded-full transition-colors 
          hover:bg-gradient-to-r hover:from-[#fa7cbb] hover:to-[#f14658] hover:text-white ${
      ...
      <div className="flex gap-4 items-center p-5 bg-white border-2 border-blue-200 rounded-2xl shadow-sm mx-4 md:mx-6 lg:mx-8 mt-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Track your habits, medication, and heart rate to better manage your
            heart health.
          </p>
        </div>
      </div>
